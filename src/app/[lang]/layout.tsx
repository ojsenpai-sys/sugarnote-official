...
export const metadata: Metadata = {
  ...
  description:
    "「Pure. Bright. Unstoppable.」日本人の精神性を主軸に、緻密で繊細なクリエイティブを展開するアイドルグループSugarNote（シュガーノート）のオフィシャルサイト。",
  keywords: [
    "SugarNote",
    "シュガーノート",
    "アイドル",
  ...
  openGraph: {
    ...
    description:
      "「Pure. Bright. Unstoppable.」日本人の精神性を主軸に、緻密で繊細なクリエイティブを展開するアイドルグループ。",
